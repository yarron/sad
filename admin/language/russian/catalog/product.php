...
$_['column_model']           = 'Латинское название';
...
$_['entry_model']            = 'Латинское название:';
...
$_['entry_top_product']      = 'ТОП ПРОДАЖ:';

$_['entry_manufacturer']     = 'Производитель:';
$_['entry_date_available']   = 'Дата поступления:';
$_['entry_quantity']         = 'Количество:<br/><span class="help">Учитывая количество в опциях</span>';
...
$_['entry_option_height']    = 'Высота:';
$_['entry_option_width']     = 'Ширина:';
$_['entry_option_plant']     = 'Количество пересадок:';
$_['entry_option_packing']   = 'Упаковка корневой системы:';
