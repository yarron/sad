...
class ControllerCatalogProduct extends Controller {
	...
	public function filter() {
  	...
  	protected function getForm() {
		...
		$this->data['entry_top_product'] = $this->language->get('entry_top_product');

		$this->data['entry_points'] = $this->language->get('entry_points');
        
		$this->data['entry_option_height'] = $this->language->get('entry_option_height');
        $this->data['entry_option_width'] = $this->language->get('entry_option_width');
        $this->data['entry_option_plant'] = $this->language->get('entry_option_plant');
        $this->data['entry_option_packing'] = $this->language->get('entry_option_packing');
		...
		if (isset($this->request->post['top_product'])) {
			$this->data['top_product'] = $this->request->post['top_product'];
		} elseif (!empty($product_info)) {
			$this->data['top_product'] = $product_info['top_product'];
		} else {
			$this->data['top_product'] = 1;
		}
		...
		if (isset($this->request->get['filter_name']) || isset($this->request->get['filter_model']) || isset($this->request->get['filter_category_id'])) {
			...
			foreach ($results as $result) {
				...
				foreach ($product_options as $product_option) {
					...
					if ($option_info) {				
						if ($option_info['type'] == 'table' || $option_info['type'] == 'select' || $option_info['type'] == 'radio' || $option_info['type'] == 'checkbox' || $option_info['type'] == 'image') {
