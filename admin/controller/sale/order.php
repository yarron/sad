...
class ControllerSaleOrder extends Controller {
	private $error = array();
  	...
  	public function getForm() {
		...
		$this->data['text_price_edit'] = $this->language->get('text_price_edit');
        $this->data['text_price_ok'] = $this->language->get('text_price_ok');
        $this->data['text_price_abort'] = $this->language->get('text_price_abort');
        $this->data['text_quantity_edit'] = $this->language->get('text_quantity_edit');
        $this->data['text_quantity_ok'] = $this->language->get('text_quantity_ok');
        $this->data['text_quantity_abort'] = $this->language->get('text_quantity_abort');
		...
		if (isset($this->error['discount_method'])) {
			$this->data['error_discount_method'] = $this->error['discount_method'];
		} else {
			$this->data['error_discount_method'] = '';
		}
    	...
    	if (isset($this->request->post['payment_country_id'])) {
      		$this->data['payment_country_id'] = 176;//$this->request->post['payment_country_id'];
    	} elseif (!empty($order_info)) {
			$this->data['payment_country_id'] = 176;//$order_info['payment_country_id'];
		} else {
      		$this->data['payment_country_id'] = 176;
    	}

		if (isset($this->request->post['payment_zone_id'])) {
      		$this->data['payment_zone_id'] = 2792;//$this->request->post['payment_zone_id'];
    	} elseif (!empty($order_info)) {
			$this->data['payment_zone_id'] = 2792;//$order_info['payment_zone_id'];
		} else {
      		$this->data['payment_zone_id'] = 2792;//'';
    	}
    	...
    	if (isset($this->request->post['payment_code'])) {
      	...
      	$this->data['payment_code'] = '';
			...
			/* discount */
			if (isset($this->request->post['discount_method'])) {
      	$this->data['discount_method'] = $this->request->post['discount_method'];
    	} elseif (!empty($order_info)) {
				$this->data['discount_method'] = $order_info['discount_method'];
			} else {
      	$this->data['discount_method'] = '';
    	}

    	if (isset($this->request->post['discount_price'])) {
      	$this->data['discount_price'] = $this->request->post['discount_price'];
    	} elseif (!empty($order_info)) {
				$this->data['discount_price'] = $order_info['discount_price'];
			} else {
    	...
    	if (isset($this->request->post['shipping_country_id'])) {
      		$this->data['shipping_country_id'] = 176;//$this->request->post['shipping_country_id'];
    	} elseif (!empty($order_info)) {
			$this->data['shipping_country_id'] = 176;//$order_info['shipping_country_id'];
		} else {
      		$this->data['shipping_country_id'] = 176;//'';
    	}

		if (isset($this->request->post['shipping_zone_id'])) {
      		$this->data['shipping_zone_id'] = 2792;//$this->request->post['shipping_zone_id'];
    	} elseif (!empty($order_info)) {
			$this->data['shipping_zone_id'] = 2792;//$order_info['shipping_zone_id'];
		} else {
      		$this->data['shipping_zone_id'] = 2792;//'';
    	}
  	...
  	protected function validateForm() {
    	...
    	if ($this->request->post['payment_method'] == '') {
			...
			if ($this->request->post['discount_method'] == '') {
      		$this->error['discount_method'] = $this->language->get('error_discount');
    	}
