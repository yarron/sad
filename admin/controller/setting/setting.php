...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
        ...
        if (isset($this->request->post['config_additional'])) {
			$this->data['config_additional'] = $this->request->post['config_additional'];
		} else {
			$this->data['config_additional'] = $this->config->get('config_additional');
		}
