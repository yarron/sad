...
class ControllerShippingFlat extends Controller {
	...
	public function index() {   
		...
		foreach ($languages as $language) {
			if (isset($this->request->post['flat_title_' . $language['language_id']])) {
				$this->data['flat_title_' . $language['language_id']] = $this->request->post['flat_title_' . $language['language_id']];
			} else {
				$this->data['flat_title_' . $language['language_id']] = $this->config->get('flat_title_' . $language['language_id']);
			}
		}
	...
	protected function validate() {
		...
		foreach ($languages as $language) {
			if (!$this->request->post['flat_title_' . $language['language_id']]) {
