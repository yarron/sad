...
class ControllerShippingPickup extends Controller {
	...
	public function index() {   
		...
		foreach ($languages as $language) {
			if (isset($this->request->post['pickup_title_' . $language['language_id']])) {
				$this->data['pickup_title_' . $language['language_id']] = $this->request->post['pickup_title_' . $language['language_id']];
			} else {
				$this->data['pickup_title_' . $language['language_id']] = $this->config->get('pickup_title_' . $language['language_id']);
			}
		}
	...
	protected function validate() {
		...
		foreach ($languages as $language) {
			if (!$this->request->post['pickup_title_' . $language['language_id']]) {
