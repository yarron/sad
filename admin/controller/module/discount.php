...
class ControllerModuleDiscount extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && ($this->validate())) {
			$this->model_setting_setting->editSetting('discount_mod', $this->request->post);		
	    ...
	    if (isset($this->request->post['discount_module'])) {
			$this->data['modules'] = $this->request->post['discount_module'];
		} elseif ($this->config->get('discount_module')) { 
			$this->data['modules'] = $this->config->get('discount_module');
		}	
