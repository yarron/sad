...
class ControllerDesignBanner extends Controller {
	...
	protected function getList() {
		...
		foreach ($results as $result) {
			...
			$this->data['banners'][] = array(
                ...
                'gallery'    => ($result['gallery'] ? $this->language->get('text_enabled') : $this->language->get('text_disabled')),				
        ...
        $this->data['column_gallery'] = $this->language->get('column_gallery');
        ...
        $this->data['sort_order'] = $this->url->link('design/banner', 'token=' . $this->session->data['token'] . '&sort=order' . $url, 'SSL');
		$this->data['sort_status'] = $this->url->link('design/banner', 'token=' . $this->session->data['token'] . '&sort=status' . $url, 'SSL');
        $this->data['sort_gallery'] = $this->url->link('design/banner', 'token=' . $this->session->data['token'] . '&sort=gallery' . $url, 'SSL');
	...
	protected function getForm() {
        ...
        $this->data['entry_gallery'] = $this->language->get('entry_gallery');
        ...
        if (isset($this->request->post['meta_title'])) {
			...
			$this->data['meta_title'] = $banner_info['meta_title'];
		} else {
		...
		if (isset($this->request->post['meta_description'])) {
			...
			$this->data['meta_description'] = $banner_info['meta_description'];
		} else {
        ...
        if (isset($this->request->post['description'])) {
			...
			$this->data['description'] = $banner_info['description'];
		} else {
        ...
        if (isset($this->request->post['gallery'])) {
			$this->data['gallery'] = $this->request->post['gallery'];
		} elseif (!empty($banner_info)) {
			$this->data['gallery'] = $banner_info['gallery'];
		} else {
