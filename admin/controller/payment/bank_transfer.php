...
class ControllerPaymentBankTransfer extends Controller {
	...
	public function index() {
		...
		$this->data['entry_title_payment'] = $this->language->get('entry_title_payment');
		...
		foreach ($languages as $language) {
			...
			if (isset($this->error['title_payment_' . $language['language_id']])) {
				$this->data['error_title_payment_' . $language['language_id']] = $this->error['title_payment_' . $language['language_id']];
			} else {
				$this->data['error_title_payment_' . $language['language_id']] = '';
			}
		}
        ...
        if (isset($this->request->post['bank_transfer_download'])) {
            $this->data['bank_transfer_download'] = $this->request->post['bank_transfer_download'];
        } else {
            $this->data['bank_transfer_download'] = $this->config->get('bank_transfer_download');
        }
		...
		foreach ($languages as $language) {
            ...
            if (isset($this->request->post['bank_transfer_title_' . $language['language_id']])) {
                $this->data['bank_transfer_title_' . $language['language_id']] = $this->request->post['bank_transfer_title_' . $language['language_id']];
            } else {
                $this->data['bank_transfer_title_' . $language['language_id']] = $this->config->get('bank_transfer_title_' . $language['language_id']);
            }

			if (isset($this->request->post['bank_transfer_title_payment_' . $language['language_id']])) {
				$this->data['bank_transfer_title_payment_' . $language['language_id']] = $this->request->post['bank_transfer_title_payment_' . $language['language_id']];
			} else {
				$this->data['bank_transfer_title_payment_' . $language['language_id']] = $this->config->get('bank_transfer_title_payment_' . $language['language_id']);
			}
		}
	...
	protected function validate() {
		...
		foreach ($languages as $language) {
            ...
            if (!$this->request->post['bank_transfer_title_' . $language['language_id']]) {
                $this->error['title_' .  $language['language_id']] = $this->language->get('error_title');
            }
			if (!$this->request->post['bank_transfer_title_payment_' . $language['language_id']]) {
				$this->error['title_payment_' .  $language['language_id']] = $this->language->get('error_title_payment');
			}
		}
