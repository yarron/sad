...
class ControllerPaymentCod extends Controller {
	...
	public function index() { 
		...
		foreach ($languages as $language) {
			if (isset($this->request->post['cod_title_' . $language['language_id']])) {
				$this->data['cod_title_' . $language['language_id']] = $this->request->post['cod_title_' . $language['language_id']];
			} else {
				$this->data['cod_title_' . $language['language_id']] = $this->config->get('cod_title_' . $language['language_id']);
			}
		}
	...
	protected function validate() {
		...
		foreach ($languages as $language) {
			if (!$this->request->post['cod_title_' . $language['language_id']]) {
