        ...
        <table class="list">
          <thead>
            <tr>
              ...
              <td class="left"><?php if ($sort == 'status') { ?>
                ...
                <?php } ?></td>
                <td class="left"><?php if ($sort == 'gallery') { ?>
                <a href="<?php echo $sort_gallery; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_gallery; ?></a>
                <?php } else { ?>
                <a href="<?php echo $sort_gallery; ?>"><?php echo $column_gallery; ?></a>
                <?php } ?></td>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="left"><?php echo $banner['sort_order']; ?></td>
              <td class="left"><?php echo $banner['status']; ?></td>
              <td class="left"><?php echo $banner['gallery']; ?></td>
