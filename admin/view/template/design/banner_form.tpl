      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          ...
          <tr>
            ...
            <td><input type="text" name="meta_title" value="<?php echo $meta_title; ?>" size="100" /></td>
          </tr>
          <tr>
            <td><?php echo $entry_meta_description; ?></td>
            <td><textarea name="meta_description" cols="100" rows="2"><?php echo $meta_description; ?></textarea></td>
          </tr>
          <tr>
...
function addImage() {
    ...
    html += '<td class="left"><input type="text" name="banner_image[' + image_row + '][sort_order]" value="0" /></td>';
    html += '<td class="left">';
