          ...
          <table class="form">
            <tr>
              ...
              <td><select name="parent_id">
                ...
                <?php if ($category['portal_id'] == $parent_id) { ?>
                <option value="<?php echo $category['portal_id']; ?>" selected="selected"><?php echo $category['name']; ?></option>
                <?php } else { ?>
                <option value="<?php echo $category['portal_id']; ?>"><?php echo $category['name']; ?></option>
                <?php } ?>
                <?php } ?>
              </select></td>
            </tr>
