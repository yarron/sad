      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <div id="tab-data">
          <table class="form">
            ...
            <tr>
              ...
              <td><input type="text" name="width" value="<?php echo $width; ?>" size="4" />
                <input type="text" name="height" value="<?php echo $height; ?>" size="4" /></td>
            </tr>
            <tr>
              <td><?php echo $entry_option_packing; ?></td>
              <td><input type="text" name="length" value="<?php echo $length; ?>" size="4" /></td>
            </tr>
            <tr>
              <td><?php echo $entry_option_plant; ?></td>
            ...
            <tr>
              ...
              <tr>
                  <td style="color:#ff0000"><?php echo $entry_top_product; ?></td>
                  <td><?php if ($top_product) { ?>
                      <input type="radio" name="top_product" value="1" checked="checked" />
                      <?php echo $text_yes; ?>
                      <input type="radio" name="top_product" value="0" />
                      <?php echo $text_no; ?>
                      <?php } else { ?>
                      <input type="radio" name="top_product" value="1" />
                      <?php echo $text_yes; ?>
                      <input type="radio" name="top_product" value="0" checked="checked" />
                      <?php echo $text_no; ?>
                      <?php } ?></td>
              </tr>
            <tr>
        ...
        <div id="tab-option">
          ...
          <div id="tab-option-<?php echo $option_row; ?>" class="vtabs-content">
            ...
            <?php if ($product_option['type'] == 'select' || $product_option['type'] == 'radio' || $product_option['type'] == 'checkbox' || $product_option['type'] == 'image' || $product_option['type'] == 'table') { ?>
            <table id="option-value<?php echo $option_row; ?>" class="list">
              <thead>
                <tr>
                  ...
                  <td class="right"><?php echo $entry_option_height; ?></td>
                  <td class="right"><?php echo $entry_option_width; ?></td>
                  <td class="right"><?php echo $entry_option_plant; ?></td>
                  <td class="right"><?php echo $entry_option_packing; ?></td>
                  <td></td>
                </tr>
              </thead>
              ...
              <tbody id="option-value-row<?php echo $option_value_row; ?>">
                ...
                <td class="left"><select name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][option_value_id]">
                  ...
                  <td class="right"><input type="text" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][height]" value="<?php echo $product_option_value['height']; ?>" size="5" /></td>
                  <td class="right"><input type="text" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][width]" value="<?php echo $product_option_value['width']; ?>" size="5" /></td>
                  <td class="right"><input type="text" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][plant]" value="<?php echo $product_option_value['plant']; ?>" size="5" /></td>
                  <td class="right"><input type="text" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][packing]" value="<?php echo $product_option_value['packing']; ?>" size="5" /></td>
...
$('input[name=\'option\']').catcomplete({
	...
	select: function(event, ui) {
		...
		if (ui.item.type == 'select' || ui.item.type == 'radio' || ui.item.type == 'checkbox' || ui.item.type == 'image' || ui.item.type == 'table') {
			...
			html += '        <td class="right"><?php echo $entry_option_height; ?></td>';
			html += '        <td class="right"><?php echo $entry_option_width; ?></td>';
            html += '        <td class="right"><?php echo $entry_option_plant; ?></td>';
			html += '        <td class="right"><?php echo $entry_option_packing; ?></td>';
			html += '        <td></td>';
			html += '      </tr>';
			html += '  	 </thead>';
			html += '    <tfoot>';
...
function addOptionValue(option_row) {	
	...
	html += '    <td class="right"><input type="text" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][height]" value="" size="5" /></td>';	
	html += '    <td class="right"><input type="text" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][width]" value="" size="5" /></td>';
    html += '    <td class="right"><input type="text" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][plant]" value="" size="5" /></td>';	
	html += '    <td class="right"><input type="text" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][packing]" value="" size="5" /></td>';
