      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
            ...
            <tr>
                ...
                <td><input name="pickup_title_<?php echo $language['language_id']; ?>" style="width:300px" value="<?php echo isset(${'pickup_title_' . $language['language_id']}) ? ${'pickup_title_' . $language['language_id']} : ''; ?>" >
