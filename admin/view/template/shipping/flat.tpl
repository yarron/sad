      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
            ...
            <tr>
                ...
                <td><input name="flat_title_<?php echo $language['language_id']; ?>" style="width:300px" value="<?php echo isset(${'flat_title_' . $language['language_id']}) ? ${'flat_title_' . $language['language_id']} : ''; ?>" >
