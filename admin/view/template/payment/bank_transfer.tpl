      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          <?php foreach ($languages as $language) { ?>
            <tr>
                <td><span class="required">*</span> <?php echo $entry_title_payment; ?></td>
                <td><input name="bank_transfer_title_payment_<?php echo $language['language_id']; ?>" value="<?php echo isset(${'bank_transfer_title_payment_' . $language['language_id']}) ? ${'bank_transfer_title_payment_' . $language['language_id']} : ''; ?>" >
                    <img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" style="vertical-align: top;" /><br />
                    <?php if (isset(${'error_title_payment_' . $language['language_id']})) { ?>
                    <span class="error"><?php echo ${'error_title_payment_' . $language['language_id']}; ?></span>
                    <?php } ?></td>
            </tr>
            <tr>
                <td><span class="required">*</span> <?php echo $entry_title; ?></td>
                <td><input name="bank_transfer_title_<?php echo $language['language_id']; ?>" value="<?php echo isset(${'bank_transfer_title_' . $language['language_id']}) ? ${'bank_transfer_title_' . $language['language_id']} : ''; ?>" >
                    <img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" style="vertical-align: top;" /><br />
          ...
          <?php } ?>
            <tr>
                ...
                <td>
                    <select name="bank_transfer_download">
                        <option value="0" ><?php echo $text_no_download; ?></option>
                        <?php foreach($downloads as $download) { ?>
                        <?php if ($bank_transfer_download == $download['download_id'] ) { ?>
