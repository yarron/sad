...
class ModelCatalogInformation extends Model {
	...
	public function getInformations($data = array()) {
		if ($data) {
			$sql = "SELECT i.information_id,id.title, i.sort_order,i.category_id, cd.name FROM " . DB_PREFIX . "information i 
            LEFT JOIN " . DB_PREFIX . "information_description id ON (i.information_id = id.information_id) 
            LEFT JOIN " . DB_PREFIX . "category_description cd ON (i.category_id = cd.category_id)
            WHERE id.language_id = '" . (int)$this->config->get('config_language_id') . "'
            OR   cd.language_id = '" . (int)$this->config->get('config_language_id') . "'
            ";
