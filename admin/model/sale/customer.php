...
class ModelSaleCustomer extends Model {
    ...
    public function setNewsletter($emails,$names, $theme, $message){
        ...
        foreach($emails as $key=>$email){
            $values[] = "('".$email."', '".$names[$key]."', '".$theme."', '".$message."',  '".date('Y-m-d H:i:s')."')";
        }
        return $this->db->query("INSERT INTO ".DB_PREFIX."newsletter (email,full_name, theme, message, date_add) VALUES ".implode(',', $values));
    }
}
?>