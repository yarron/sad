...
class ControllerCommonHeader extends Controller {
	protected function index() {
        ...
        $this->data['text_sub_logotype'] = $this->language->get('text_sub_logotype');
        ...
        $this->data['buy'] = $this->url->link('information/information&information_id=8');
        $this->data['delivery'] = $this->url->link('information/information&information_id=6');
        $this->data['contact'] = $this->url->link('information/contact');
		//$this->data['wishlist'] = $this->url->link('account/wishlist', '', 'SSL');
        $this->data['login'] = $this->url->link('account/login', '', 'SSL');
        $this->data['logout'] = $this->url->link('account/logout', '', 'SSL');
        $this->data['register'] = $this->url->link('account/register', '', 'SSL');
        $this->data['profile'] = $this->url->link('account/account', '', 'SSL');
