				...
				if ($product_query->num_rows) {
					...
					foreach ($options as $product_option_id => $option_value) {
						...
						if ($option_query->num_rows) {
							if ($option_query->row['type'] == 'select' || $option_query->row['type'] == 'radio' || $option_query->row['type'] == 'image' || $option_query->row['type'] == 'table') {
								...
								if ($option_value_query->num_rows) {
									...
									$option_data[] = array(
										...
										'height'                  => $option_value_query->row['height'],
										'width'           => $option_value_query->row['width'],									
										'plant'                  => $option_value_query->row['plant'],
										'packing'           => $option_value_query->row['packing']
									);								
								}
